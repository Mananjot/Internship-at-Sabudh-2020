...
So maximum profit you can earn is : m * x where m is total number of buyers whose budget is greater than or equal to x.
...
Explanation 2
Price of your app should be Rs. 67. You can get the profit Rs. 
"""
